...
практик DevOps и SRE в реальную жизнь.`,
  ...
  skills: [
    {
      key: { en: "Languages", ru: "Языки программирования" },
      value: "Python, Bash, PowerShell, Go (beginner)",
      contexts: ["cv"],
    },
    ...
    {
      key: { en: "Web / LB", ru: "Web / балансировщики" },
      value: "Nginx, OpenResty, HAProxy",
      contexts: ["cv"],
    },
    {
      key: { en: "CI/CD", ru: "CI/CD" },
      value: "Jenkins, GitLab CI, Terraform, Ansible",
      contexts: ["cv"],
    },
    {
      key: { en: "Containers", ru: "Контейнеры" },
      value: "ECS, Kubernetes, OpenShift, Docker, Helm",
    },
    {
      key: { en: "Virtualization", ru: "Виртуализация" },
      value: "libvirt, LXC, Ceph, MAAS",
      contexts: ["cv"],
    },
    {
      key: { en: "Cloud", ru: "Облако" },
      value: "AWS (primarily), GCP, Azure, Yandex Cloud, OpenStack",
    },
    {
      key: { en: "Databases", ru: "Базы данных" },
      value: "PostgreSQL, MariaDB, MySQL, ClickHouse, MongoDB",
    },
    {
      key: { en: "Monitoring", ru: "Мониторинг" },
      value: "Prometheus, Grafana, ELK Stack, Graylog, CloudWatch",
      contexts: ["cv"],
    },
  ],
  ...
  socials: [
    ...
    },
    {
      contexts: ["terminal"],
      label: "Twitter",
      href: "https://twitter.com/thatguynikita",
      display: "@thatguynikita",
    },
    {
      contexts: ["terminal"],
      label: "Facebook",
    ...
    },
    {
      contexts: ["terminal"],
      label: "Instagram",
      href: "https://www.instagram.com/thatguynikita",
      display: "@thatguynikita",
    },
  ],
...
копилку.`,
    ...
    jobs: [
      ...
      },
      {
        ...
        org: {
          ...
          url: "",
          location: {
            en: "Saint Petersburg · ex. T-Systems",
            ru: "Санкт-Петербург · ранее T-Systems",
          },
        },
      ...
      },
      {
        ...
        title: {
          en: "Application Support Specialist (Tier 2)",
          ru: "Специалист технической поддержки (2-я линия)",
        },
    ...
    languages: [
      { name: { en: "Russian", ru: "Русский" }, filled: 10, sub: { en: "Native", ru: "Родной" } },
      {
        ...
        filled: 8,
        sub: { en: "C1 — Advanced", ru: "C1 — Продвинутый" },
      },
      {
        name: { en: "German", ru: "Немецкий" },
        filled: 3,
        sub: { en: "A2 — Elementary", ru: "A2 — Начальный" },
      },
      {
        name: { en: "Spanish", ru: "Испанский" },
        filled: 5,
        sub: { en: "B1 — Intermediate", ru: "B1 — Средний" },
      },
    ],
    traits: {
      en: [
